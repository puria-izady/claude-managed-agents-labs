...
This lab is **Console-only** - no Python required. There's no code to run in
this folder.
...
You can also do the exact same thing via the Managed Agents beta SDK instead
of clicking through the Console (the SDK adds the required beta header for
you). If you show code, the captioned current values are model
`claude-haiku-4-5-20251001` and toolset `agent_toolset_20260401`.
